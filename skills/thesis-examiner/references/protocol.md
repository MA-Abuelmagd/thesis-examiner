<!-- Thesis Examiner examination protocol · version 1.0.0 — tracks .claude-plugin/plugin.json; bump both together on every release. Single source of truth (docs/portable-prompt.md mirrors this file). -->
